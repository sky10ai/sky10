...
func LoadPackIndex(ctx context.Context, backend skyadapter.Backend, id *Identity) (*PackIndex, error) {
...
func SavePackIndex(ctx context.Context, backend skyadapter.Backend, idx *PackIndex, id *Identity) error {
...
func NewPackWriter(backend skyadapter.Backend, identity *Identity, index *PackIndex) *PackWriter {
	return &PackWriter{
		backend:  backend,
		identity: identity,
		index:    index,
...
func ReadPackedChunk(ctx context.Context, backend skyadapter.Backend, loc PackLocation) ([]byte, error) {
