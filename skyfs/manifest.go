...
func SaveManifest(ctx context.Context, backend skyadapter.Backend, m *Manifest, id *Identity) error {
...
func LoadManifest(ctx context.Context, backend skyadapter.Backend, id *Identity) (*Manifest, error) {
