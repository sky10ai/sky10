...
// TestSymlinkRoundTripMinIO and TestSymlinkDanglingMinIO deleted:
// Used writeOp/getOpsLog which are dead. In-memory tests above cover
// the same logic. MinIO integration is tested via snapshot_poller tests.
