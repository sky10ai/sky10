...
var openClawLimaProgressPlan = []progressStep{
	{ID: "sandbox.prepare", Summary: "Preparing sandbox...", Weight: 5},
	{ID: "vm.start", Summary: "Booting device...", Weight: 10},
	{ID: "guest.system.packages", Summary: "Installing system packages...", Weight: 15},
	{ID: "guest.node.install", Summary: "Installing Node.js...", Weight: 8},
	{ID: "guest.openclaw.install", Summary: "Installing OpenClaw...", Weight: 12},
	{ID: "guest.chromium.install", Summary: "Installing Chromium...", Weight: 12},
	{ID: "guest.caddy.install", Summary: "Installing Caddy...", Weight: 5},
	{ID: "guest.sky10.start", Summary: "Starting guest sky10...", Weight: 5},
	{ID: "guest.openclaw.configure", Summary: "Configuring OpenClaw...", Weight: 7},
	{ID: "guest.openclaw.start", Summary: "Starting OpenClaw...", Weight: 8},
	{ID: "ready.openclaw.gateway", Summary: "Waiting for OpenClaw gateway...", Weight: 5},
	{ID: "ready.guest.sky10", Summary: "Waiting for guest sky10...", Weight: 2},
	{ID: "ready.guest.identity", Summary: "Confirming guest identity...", Weight: 2},
	{ID: "ready.guest.agent", Summary: "Waiting for agent registration...", Weight: 2},
	{ID: "ready.host.connect", Summary: "Connecting host to guest...", Weight: 2},
}

var hermesLimaProgressPlan = []progressStep{
	{ID: "sandbox.prepare", Summary: "Preparing sandbox...", Weight: 5},
	{ID: "vm.start", Summary: "Booting device...", Weight: 10},
	{ID: "guest.system.packages", Summary: "Installing system packages...", Weight: 12},
	{ID: "guest.hermes.install", Summary: "Installing Hermes...", Weight: 25},
	{ID: "guest.hermes.configure", Summary: "Configuring Hermes...", Weight: 12},
	{ID: "guest.sky10.start", Summary: "Starting guest sky10...", Weight: 8},
	{ID: "guest.hermes.bridge.start", Summary: "Starting Hermes bridge...", Weight: 12},
	{ID: "ready.guest.hermes", Summary: "Waiting for Hermes CLI...", Weight: 4},
	{ID: "ready.guest.sky10", Summary: "Waiting for guest sky10...", Weight: 3},
	{ID: "ready.guest.identity", Summary: "Confirming guest identity...", Weight: 3},
	{ID: "ready.guest.agent", Summary: "Waiting for agent registration...", Weight: 4},
	{ID: "ready.host.connect", Summary: "Connecting host to guest...", Weight: 2},
}
...
var openClawDockerLimaProgressPlan = []progressStep{
	{ID: "sandbox.prepare", Summary: "Preparing sandbox...", Weight: 5},
	{ID: "vm.start", Summary: "Booting device...", Weight: 10},
	{ID: "guest.system.packages", Summary: "Installing Docker runtime...", Weight: 18},
	{ID: "guest.docker.configure", Summary: "Configuring Docker runtime...", Weight: 7},
	{ID: "guest.docker.pull", Summary: "Pulling Docker runtime images...", Weight: 18},
	{ID: "guest.docker.build", Summary: "Building Docker containers...", Weight: 14},
	{ID: "guest.docker.start", Summary: "Starting OpenClaw containers...", Weight: 8},
	{ID: "ready.openclaw.gateway", Summary: "Waiting for OpenClaw gateway...", Weight: 7},
	{ID: "ready.guest.sky10", Summary: "Waiting for guest sky10...", Weight: 4},
	{ID: "ready.guest.identity", Summary: "Confirming guest identity...", Weight: 3},
	{ID: "ready.guest.agent", Summary: "Waiting for agent registration...", Weight: 4},
	{ID: "ready.host.connect", Summary: "Connecting host to guest...", Weight: 2},
}
...
var hermesDockerLimaProgressPlan = []progressStep{
	...
	{ID: "guest.docker.configure", Summary: "Configuring Docker runtime...", Weight: 7},
	{ID: "guest.docker.pull", Summary: "Pulling Docker runtime images...", Weight: 18},
	{ID: "guest.docker.build", Summary: "Building Hermes container...", Weight: 14},
	{ID: "guest.docker.start", Summary: "Starting Hermes containers...", Weight: 8},
	{ID: "ready.guest.hermes", Summary: "Waiting for Hermes CLI...", Weight: 5},
	{ID: "ready.guest.sky10", Summary: "Waiting for guest sky10...", Weight: 4},
	{ID: "ready.guest.identity", Summary: "Confirming guest identity...", Weight: 3},
	{ID: "ready.guest.agent", Summary: "Waiting for agent registration...", Weight: 5},
	{ID: "ready.host.connect", Summary: "Connecting host to guest...", Weight: 3},
}
